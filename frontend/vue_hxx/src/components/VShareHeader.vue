<template>
    <div class="header">
        <div class="my-header" v-if="profileFormData.login == 'false'">
            <nav class="navbar bg-light">
                <div class="container-fluid">
                    ...
                    <div class="sign-in-up">
                        <router-link class="btn btn-outline-primary" to="/signin" role="button">Sign in</router-link>
                        <router-link class="btn btn-outline-primary" to="/signup" role="button">Sign up</router-link>
                    </div>
                    <div class="homepage-avatar-container">
                        <router-link to="/profile" target="_blank"><img class="account-avatar" src="resources/ZCC.JPG"
