    ...
    <div class="Category">
      <div class="box">
        <router-link
          ...
          :to="{
            path: '/video',
            query: { videoname: title, videopath: videopath },
          }"
        >
          <ul>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                <el-button plain>
                  <router-link
                    target="_blank"
                    :to="{ path: '/Pages', query: { title: label } }"
                    >{{ label }}{{ $route.query.label }}</router-link
                  >
                </el-button>
              </p>
              <p>
                likes number:{{ likes }}{{ $route.query.likes }} dislikes
                number:{{ dislikes }}{{ $route.query.dislikes }}
              </p>
            </li>
          </ul>
        </router-link>
